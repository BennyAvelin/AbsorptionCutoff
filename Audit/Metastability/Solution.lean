...
lemma roundedExistenceThresholdSq_eq :
    roundedExistenceThresholdSq =
      AbsorptionCutoff.roundedExistenceThresholdSq := rfl
...
lemma roundedRadiusSq_eq (ρ : ℝ) (N : ℕ) :
    roundedRadiusSq ρ N = AbsorptionCutoff.roundedRadiusSq ρ N := rfl
...
lemma metastableExitEvent_eq (upper η : ℝ) (t₀ T : ℕ) :
    metastableExitEvent upper η t₀ T =
      AbsorptionCutoff.metastableExitEvent upper η t₀ T := rfl
...
theorem rounded_qualitative_metastability
  ...
  AbsorptionCutoff.MainTheorems.rounded_qualitative_metastability hρ hρ_lt hA
